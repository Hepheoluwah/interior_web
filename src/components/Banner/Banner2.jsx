      ...
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            ...
            >
              From concept to completion, we craft living rooms that balance
              comfort with sophistication. Clean lines, layered textures, and
              statement pieces come together to create spaces made for real life.
            </motion.p>
            <motion.div
