...
const ServiceCard = [
  {
    ...
    description:
      "Bespoke kitchens, serene bedrooms, and elevated living spaces tailored to how you live.",
    icon: <FaVectorSquare />,
    link: "#",
    delay: 0.2,
  },
  {
    ...
    description:
      "We source enduring materials and partner with trusted makers for uncompromising quality.",
    icon: <FaPenToSquare />,
    link: "#",
    delay: 0.4,
  },
  {
    ...
    description:
      "Transparent budgets and smart planning to maximize impact without sacrificing design.",
